# Migration `20200624181038-init`

This migration has been generated by Marc Stammerjohann at 6/24/2020, 6:10:38 PM.
...
"authorId" text   ,"content" text   ,"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"id" text  NOT NULL ,"published" boolean  NOT NULL ,"title" text  NOT NULL ,"updatedAt" timestamp(3)  NOT NULL ,
    PRIMARY KEY ("id"))
